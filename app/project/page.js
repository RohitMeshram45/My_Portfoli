...
const Projects = () => {
    return (
        <> 
        <h2 id="project" className=" mb-5 mt-9 text-5xl tracking-tight font-extrabold text-center text-gray-500 dark:text-slate-500">Personal Projects </h2>
        ...
        <section className='flex justify-center gap-28 max-sm:items-center  max-sm:flex-col'>
            ...
            transition={{ duration: 0.4 }} 
                ...
                <div className="p-6 text-center font-semibold text-slate-900">
                    <h1 className='text-2xl'>Voting Application</h1>
