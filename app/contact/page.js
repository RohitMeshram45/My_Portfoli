...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs.sendForm('service_zl48bas', 'template_51ejt3b', form.current, 'DxAdwkQyilTNm_dXo')
            .then((result) => {
    ...
    return (
        <section id="contact" className="mt-16 bg-gradient-to-t from-cyan-100 to-cyan-250">
            <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
                ...
                <form ref={form} onSubmit={sendEmail} className="space-y-8">
                    ...
                    <motion.button whileHover={{ scale: [null, 1, 1.02] }}
                        transition={{ duration: 0.2 }} type="submit" className="flex justify-center items-center gap-2 bg-blue-600 hover:bg-blue-500 py-3 px-5 text-sm font-medium text-center text-black rounded-lg bg-primary-700 sm:w-fit hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
